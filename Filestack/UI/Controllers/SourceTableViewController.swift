...
internal class SourceTableViewController: UITableViewController {
    ...
    public override func viewDidLoad() {
        ...
        if let navigationController = navigationController as? PickerNavigationController {
            ...
            self.cloudSources = client.config.availableCloudSources.compactMap {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.imageView?.image = UIImage(named: source.iconName, in: Bundle(for: type(of: self)), compatibleWith: nil)?.withRenderingMode(.alwaysTemplate)
